...
# Add 4 sliders for numeric values - 'bill_length_mm', 'bill_depth_mm', 'flipper_length_mm', 'body_mass_g' 
...
# Add a select box to store the sex of the Penguin with the 'Gender' label and options ('Male', 'Female').
# Store it in a variable 'sex'.
...
# Add a select box to store the island of the Penguin with the 'Island' label and options ('Biscoe', 'Dream', 'Torgersen').
# Store it in a variable 'isl'.
isl = st.sidebar.selectbox('Island', ('Biscoe', 'Dream', 'Torgersen'))

# Convert 'isl' to numeric
if 'isl' == 'Biscoe' :
	isl = 0
elif 'isl' == 'Dream' :
    isl = 1
...
# Add a select box in the sidebar with the 'Classifier' label. Store the selected classifier in a variable 'classifier'.
...
# Store the predicted value in the 'species_type' variable and accuracy score of the model in the 'score' variable. 
# Print the values of 'species_type' and 'score' variables using the 'st.write()' function.
